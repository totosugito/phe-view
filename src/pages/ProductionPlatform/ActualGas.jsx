...
const ActualGas = ({title="Actual Gas", idxData = 4, idxSma7 = 10, idxSma30 = 11, idxActual = -1}) => {
            ...
            {(data && filteredData) &&
              <div className="bordered pt-1 flex-1">
                ...
                <div className={`flex flex-grow w-full h-full ${activeTab === 2 ? '' : 'hidden'}`}>
                  <TabSummaryGas values={data.groups} filterList={data.summary.keys} selectedItem={selectedItem} labelKey={"Actual Gas"}/>
                </div>
              </div>
            }
          </div>
